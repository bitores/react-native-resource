...
public class ColorPickerView extends View {  
    ...
    private final int mInitColor = 0xFFFF0000;

    private final EventDispatcher mEventDispatcher;
      
    ColorPickerView(ReactContext reactContext) { 
        super(reactContext); 
        ...
        mCenterPaint.setColor(mInitColor);  
            ...
            case MotionEvent.ACTION_UP:  
                if (mTrackingCenter) {  
                    if (inCenter) {  
                        ...
                        mEventDispatcher.dispatchEvent(new ItemSelectedEvent(getId(), Integer.toHexString(mCenterPaint.getColor())));  
                    }  
...
class ItemSelectedEvent extends Event<ItemSelectedEvent> {
    ...
    public static final String EVENT_NAME = "colorPickerViewSelected";
